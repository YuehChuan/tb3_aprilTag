...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot3_gazebo_SOURCE_PREFIX /home/schwarm/tb3_aprilTag/catkin_ws/src/turtlebot3_simulations/turtlebot3_gazebo)
  set(turtlebot3_gazebo_DEVEL_PREFIX /home/schwarm/tb3_aprilTag/catkin_ws/devel)
  ...
  set(turtlebot3_gazebo_INSTALL_PREFIX /home/schwarm/tb3_aprilTag/catkin_ws/install)
...
if(NOT "/home/schwarm/tb3_aprilTag/catkin_ws/src/turtlebot3_simulations/turtlebot3_gazebo/include " STREQUAL " ")
  set(turtlebot3_gazebo_INCLUDE_DIRS "")
  set(_include_dirs "/home/schwarm/tb3_aprilTag/catkin_ws/src/turtlebot3_simulations/turtlebot3_gazebo/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'turtlebot3_gazebo' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Pyo <pyo@robotis.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'turtlebot3_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/schwarm/tb3_aprilTag/catkin_ws/src/turtlebot3_simulations/turtlebot3_gazebo/${idir}'.  Ask the maintainer 'Pyo <pyo@robotis.com>' to fix it.")
    endif()
