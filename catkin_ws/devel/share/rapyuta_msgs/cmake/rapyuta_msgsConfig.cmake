...
if(NOT "/home/schwarm/tb3_aprilTag/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rapyuta_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/schwarm/tb3_aprilTag/catkin_ws/src/rapyuta_msgs/${idir}'.  Ask the maintainer 'rapyuta <rapyuta@todo.todo>' to fix it.")
    endif()
