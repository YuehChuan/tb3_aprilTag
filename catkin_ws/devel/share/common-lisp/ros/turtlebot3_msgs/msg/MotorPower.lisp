...
(cl:defmethod cl:initialize-instance :after ((m <MotorPower>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorPower)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot3_msgs-msg:<MotorPower> is deprecated: use turtlebot3_msgs-msg:MotorPower instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <MotorPower>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot3_msgs-msg:state-val is deprecated.  Use turtlebot3_msgs-msg:state instead.")
  (state m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MotorPower>)))
  ...
  (cl:format cl:nil "# Turn on/off Dynamixels~%~%# State~%uint8 OFF = 0~%uint8 ON  = 1~%~%uint8 state~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MotorPower)))
  "Returns full string definition for message of type 'MotorPower"
  (cl:format cl:nil "# Turn on/off Dynamixels~%~%# State~%uint8 OFF = 0~%uint8 ON  = 1~%~%uint8 state~%~%~%"))
