...
(cl:defclass <AprilTagDetections> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (detections
    :reader detections
    :initarg :detections
    :type (cl:vector rapyuta_msgs-msg:AprilTagDetection)
   :initform (cl:make-array 0 :element-type 'rapyuta_msgs-msg:AprilTagDetection :initial-element (cl:make-instance 'rapyuta_msgs-msg:AprilTagDetection))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <AprilTagDetections>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AprilTagDetections)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rapyuta_msgs-msg:<AprilTagDetections> is deprecated: use rapyuta_msgs-msg:AprilTagDetections instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <AprilTagDetections>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rapyuta_msgs-msg:header-val is deprecated.  Use rapyuta_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'detections-val :lambda-list '(m))
(cl:defmethod detections-val ((m <AprilTagDetections>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rapyuta_msgs-msg:detections-val is deprecated.  Use rapyuta_msgs-msg:detections instead.")
  (detections m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AprilTagDetections>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'detections)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'rapyuta_msgs-msg:AprilTagDetection))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AprilTagDetections>)))
  ...
  "rapyuta_msgs/AprilTagDetections")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AprilTagDetections)))
  "Returns string type for a message object of type 'AprilTagDetections"
  "rapyuta_msgs/AprilTagDetections")
