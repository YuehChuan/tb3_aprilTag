...
(cl:defmethod cl:initialize-instance :after ((m <AprilTagDetection>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AprilTagDetection)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rapyuta_msgs-msg:<AprilTagDetection> is deprecated: use rapyuta_msgs-msg:AprilTagDetection instead.")))
...
(cl:defmethod id-val ((m <AprilTagDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rapyuta_msgs-msg:id-val is deprecated.  Use rapyuta_msgs-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'corners2d-val :lambda-list '(m))
(cl:defmethod corners2d-val ((m <AprilTagDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rapyuta_msgs-msg:corners2d-val is deprecated.  Use rapyuta_msgs-msg:corners2d instead.")
  (corners2d m))

(cl:ensure-generic-function 'tag_size-val :lambda-list '(m))
(cl:defmethod tag_size-val ((m <AprilTagDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rapyuta_msgs-msg:tag_size-val is deprecated.  Use rapyuta_msgs-msg:tag_size instead.")
  (tag_size m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <AprilTagDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rapyuta_msgs-msg:pose-val is deprecated.  Use rapyuta_msgs-msg:pose instead.")
  (pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AprilTagDetection>)))
  ...
  "rapyuta_msgs/AprilTagDetection")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AprilTagDetection)))
  "Returns string type for a message object of type 'AprilTagDetection"
  "rapyuta_msgs/AprilTagDetection")
