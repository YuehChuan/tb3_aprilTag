...
if("TRUE" STREQUAL "TRUE")
  set(apriltags_SOURCE_PREFIX /home/schwarm/tb3_aprilTag/catkin_ws/src/apriltags)
  set(apriltags_DEVEL_PREFIX /home/schwarm/tb3_aprilTag/catkin_ws/devel)
  ...
  set(apriltags_INSTALL_PREFIX /home/schwarm/tb3_aprilTag/catkin_ws/install)
...
if(NOT "/home/schwarm/tb3_aprilTag/catkin_ws/devel/include;/home/schwarm/tb3_aprilTag/catkin_ws/src/apriltags/include " STREQUAL " ")
  set(apriltags_INCLUDE_DIRS "")
  set(_include_dirs "/home/schwarm/tb3_aprilTag/catkin_ws/devel/include;/home/schwarm/tb3_aprilTag/catkin_ws/src/apriltags/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltags' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/schwarm/tb3_aprilTag/catkin_ws/src/apriltags/${idir}'.  Ask the maintainer 'Aaron Walsman <awalsman@andrew.cmu.edu>' to fix it.")
    endif()
