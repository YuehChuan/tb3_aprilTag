...
"""autogenerated by genpy from apriltags/AprilTagDetections.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','apriltags/AprilTagDetection[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = apriltags.msg.AprilTagDetection()
        _v6 = val1.header
        start = end
        end += 4
