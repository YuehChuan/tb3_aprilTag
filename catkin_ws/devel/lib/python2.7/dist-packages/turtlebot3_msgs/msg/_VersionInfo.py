...
"""autogenerated by genpy from turtlebot3_msgs/VersionInfo.msg. Do not edit."""
import sys
...
class VersionInfo(genpy.Message):
  ...
  _full_text = """string hardware   # <yyyy>.<mm>.<dd>        : hardware version of Turtlebot3 (ex. 2017.05.23)
